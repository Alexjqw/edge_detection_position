...
```bash
./calibrate -w 8 -h 6 -n 30 -s 0.0190 -d "../calib_imgs/1/" -i "left" -o "cam_left.yml" -e "jpg"
```
./calibrate -w 8 -h 6 -n 60 -s 0.030 -d "../calib_imgs/1/" -i "left" -o "cam_left.yml" -e "jpg"
./calibrate -w 8 -h 6 -n 60 -s 0.030 -d "../calib_imgs/1/" -i "right" -o "cam_right.yml" -e "jpg"
